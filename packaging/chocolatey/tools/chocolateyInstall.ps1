...
if ($env:PROCESSOR_ARCHITECTURE -eq 'ARM64') {
    ...
    throw "32-bit Windows is not supported. gmail-readonly requires 64-bit Windows."
}

$baseUrl = "https://github.com/open-cli-collective/gmail-ro/releases/download/v${version}"
$zipFile = "gmro_v${version}_windows_${arch}.zip"
$url = "${baseUrl}/${zipFile}"

Write-Host "Installing gmail-readonly ${version} for Windows ${arch}..."
Write-Host "URL: ${url}"
...
Write-Host "gmail-readonly installed successfully. Run 'gmro --help' to get started."
